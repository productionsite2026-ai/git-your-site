...
import { Users, PlusCircle, FileText, Shield, Sparkles, Dog, Send, Eye, CheckCircle } from 'lucide-react';
...
import { OwnerSection, ProviderSection, ServiceRequestCard, RequestFilters, ServiceRequest, ServiceRequestForm, ServiceRequestFormNew } from "@/components/hub";
        ...
        <div id="requests-section" className="scroll-mt-24">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-6">
              ...
              <TabsTrigger value="deposer" className="gap-2">
            ...
            <TabsContent value="deposer">
              ...
              >
                <ServiceRequestFormNew onSubmit={(data) => {
                  // Handle form submission, e.g., send to Supabase
                  console.log("New service request submitted:", data);
                  toast({
                    title: "Demande déposée",
                    description: "Votre demande de service a été publiée avec succès !",
                  });
                  // Optionally, navigate to the 'annonces' tab or clear the form
                  setActiveTab('annonces');
                }} />
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="space-y-3 mb-6">
                            <li className="flex items-center gap-3 text-sm">
                              ...
                              <span>Publication gratuite et rapide</span>
                            </li>
                            <li className="flex items-center gap-3 text-sm">
                              <Eye className="h-4 w-4 text-primary flex-shrink-0" />
                              <span>Visible par tous les prestataires</span>
                            </li>
                            <li className="flex items-center gap-3 text-sm">
                              <CheckCircle className="h-4 w-4 text-primary flex-shrink-0" />
                              <span>Réponses sous 24h en moyenne</span>
                            </li>
                          </ul>
                          <Button 
                            size="lg" 
