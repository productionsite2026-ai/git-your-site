...
import { MessageCircle, LogIn, LayoutDashboard, X, UserPlus } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const check = async () => {
      ...
      if (session) {
        ...
        // Vérifier s'il y a une réservation active (paiement bloqué)
            ...
            <div className="space-y-2">
              {isAuthenticated ? (
                <>
                  ...
                  {/* Messagerie — uniquement si service actif (paiement bloqué) */}
                  {hasActiveService && (
                    <button
